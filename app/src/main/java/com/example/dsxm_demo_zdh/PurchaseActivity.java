...
public class PurchaseActivity extends BaseActivity<PurchaseContract.Presenter> implements PurchaseContract.View {
    ...
    @Override
    protected PurchaseContract.Presenter createPersenter() {
