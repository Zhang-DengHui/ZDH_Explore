HLDDZNewLotteryPanelSpecial = {}
local this = HLDDZNewLotteryPanelSpecial
PObject.extend(this)

local imagePath = "HLDDZNewLotterySpecialPanel/"
local lotteryImgPath = "NewLotteryPanel/"
local jsonPath = "HLDDZNewLotterySpecialPanel/"
...
function this.initLayer()
	Log.i("HLDDZNewLotteryPanelSpecial initLayer")

	this.widgetTable.mainWidget = GUIReader:shareReader():widgetFromJsonFile(jsonPath.."HLDDZNewLotteryPanelSpecial.json")
	if not this.widgetTable.mainWidget then
		Log.e("HLDDZNewLotteryPanelSpecial Read WidgetFromJsonFile Fail")
		return
	end
	...
	this.widgetTable.lottery_panel_text:setPosition(ccp(UITools.WIN_SIZE_W/2,UITools.WIN_SIZE_H/2))
    ...
    --pad
    if ratio <= 1.34 then
        this.widgetTable.lottery_panel_text:setPositionX(550)
        this.widgetTable.lottery_panel_text:setPositionY(407)

    --iphoneX
    elseif ratio >= 2.15 then
	this.widgetTable.lottery_panel_text:setPositionX(720)
        this.widgetTable.lottery_panel_text:setPositionY(307)
    else
        this.widgetTable.lottery_panel_text:setPositionX(550)
        this.widgetTable.lottery_panel_text:setPositionY(292)
    end
    Log.d("xiangxiang position:" .. this.widgetTable.lottery_panel_text:getPositionX() .. "," .. this.widgetTable.lottery_panel_text:getPositionY())
	...
	--left_bg_table Children
	this.widgetTable.left_progress_bg = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_bg_table, "left_progress_bg"),"ImageView")
	this.widgetTable.left_progress_bg:loadTexture(imagePath .. "bg_bar.png")
	this.widgetTable.packet_under10 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_bg_table, "packet_under10"),"ImageView")
	this.widgetTable.packet_under10:loadTexture(imagePath .. "bg_pro.png")
	this.widgetTable.packet_under1 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_bg_table, "packet_under1"),"ImageView")
	this.widgetTable.packet_under1:loadTexture(imagePath .. "bg_pro.png")
	this.widgetTable.packet_under2 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_bg_table, "packet_under2"),"ImageView")
	this.widgetTable.packet_under2:loadTexture(imagePath .. "bg_pro.png")
	this.widgetTable.packet_under3 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_bg_table, "packet_under3"),"ImageView")
	this.widgetTable.packet_under3:loadTexture(imagePath .. "bg_pro.png")
	this.widgetTable.packet_under4 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_bg_table, "packet_under4"),"ImageView")
	this.widgetTable.packet_under4:loadTexture(imagePath .. "bg_pro.png")
	this.widgetTable.packet_under5 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_bg_table, "packet_under5"),"ImageView")
	this.widgetTable.packet_under5:loadTexture(imagePath .. "bg_pro.png")
	this.widgetTable.packet_under6 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_bg_table, "packet_under6"),"ImageView")
	this.widgetTable.packet_under6:loadTexture(imagePath .. "bg_pro.png")
	this.widgetTable.packet_under7 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_bg_table, "packet_under7"),"ImageView")
	this.widgetTable.packet_under7:loadTexture(imagePath .. "bg_pro.png")
	this.widgetTable.packet_under8 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_bg_table, "packet_under8"),"ImageView")
	this.widgetTable.packet_under8:loadTexture(imagePath .. "bg_pro.png")
	this.widgetTable.packet_under9 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_bg_table, "packet_under9"),"ImageView")
	this.widgetTable.packet_under9:loadTexture(imagePath .. "bg_pro.png")
	this.widgetTable.Image_dec2 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_bg_table, "Image_dec2"),"ImageView")
	this.widgetTable.Image_dec2:loadTexture(imagePath .. "bottom.png")
	this.widgetTable.change_pool_btn = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_bg_table, "change_pool_btn"),"Button")
	this.widgetTable.change_pool_btn:loadTextures(imagePath .. "btn_hjc.png", imagePath .. "btn_hjc.png", imagePath .. "btn_hjc_hui.png")
	this.widgetTable.open_packet_btn = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_bg_table, "open_packet_btn"),"Button")
	this.widgetTable.open_packet_btn:loadTextures(imagePath .. "btn_cjz.png", imagePath .. "btn_cjz.png", imagePath .. "btn_cjz_hui.png")
	this.widgetTable.receive_btn1 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_bg_table, "receive_btn1"),"Button")
	this.widgetTable.receive_btn1:loadTextures(imagePath .. "btn_tl.png", "", "")
	this.widgetTable.receive_btn2 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_bg_table, "receive_btn2"),"Button")
	this.widgetTable.receive_btn2:loadTextures(imagePath .. "btn_hld.png", "", "")
	this.widgetTable.left_btn_show = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_bg_table, "left_btn_show"),"Button")
	this.widgetTable.left_btn_show:loadTextures(imagePath .. "btn_qbjl.png", "", "")

	--left_progress_bg Children
	this.widgetTable.redpoint_bar1 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_progress_bg, "redpoint_bar1"),"ImageView")
	this.widgetTable.redpoint_bar1:loadTexture(imagePath .. "bar_circle.png")
	this.widgetTable.redpoint_bar2 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_progress_bg, "redpoint_bar2"),"ImageView")
	this.widgetTable.redpoint_bar2:loadTexture(imagePath .. "bar_circle.png")
	this.widgetTable.redpoint_bar3 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_progress_bg, "redpoint_bar3"),"ImageView")
	this.widgetTable.redpoint_bar3:loadTexture(imagePath .. "bar_circle.png")
	this.widgetTable.redpoint_bar4 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_progress_bg, "redpoint_bar4"),"ImageView")
	this.widgetTable.redpoint_bar4:loadTexture(imagePath .. "bar_circle.png")
	this.widgetTable.redpoint_bar5 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_progress_bg, "redpoint_bar5"),"ImageView")
	this.widgetTable.redpoint_bar5:loadTexture(imagePath .. "prompt.png")
	this.widgetTable.redpoint_bar6 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_progress_bg, "redpoint_bar6"),"ImageView")
	this.widgetTable.redpoint_bar6:loadTexture(imagePath .. "bar_circle.png")
	this.widgetTable.redpoint_bar7 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_progress_bg, "redpoint_bar7"),"ImageView")
	this.widgetTable.redpoint_bar7:loadTexture(imagePath .. "bar_circle.png")
	this.widgetTable.redpoint_bar8 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_progress_bg, "redpoint_bar8"),"ImageView")
	this.widgetTable.redpoint_bar8:loadTexture(imagePath .. "bar_circle.png")
	this.widgetTable.redpoint_bar9 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_progress_bg, "redpoint_bar9"),"ImageView")
	this.widgetTable.redpoint_bar9:loadTexture(imagePath .. "bar_circle.png")
	this.widgetTable.redpoint_bar10 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_progress_bg, "redpoint_bar10"),"ImageView")
	this.widgetTable.redpoint_bar10:loadTexture(imagePath .. "prompt.png")
	this.widgetTable.left_progress_bar = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.left_progress_bg, "left_progress_bar"),"ImageView")
	...
	this.widgetTable.packetChildTable[1].packet_gift1:loadTexture(imagePath .. "jipai.png")
	...
	this.widgetTable.packetChildTable[2].packet_gift1:loadTexture(imagePath .. "jipai.png")
	...
	--this.widgetTable.packet_above1:loadTexture(imagePath .. "panel_pro.png")
	...
	this.widgetTable.normal_text1 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.change_pool_btn, "normal_text1"),"Label")
	...
	this.widgetTable.normal_text2 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.open_packet_btn, "normal_text2"),"Label")
	...
	this.widgetTable.right_bottom_btn:loadTextures(imagePath .. "btn_ckjl.png", "", "")
	...
	this.widgetTable.Image_dec3:loadTexture(imagePath .. "left.png")
	...
	this.widgetTable.Image_dec1:loadTexture(imagePath .. "right.png")
	...
	this.widgetTable.right_icon_tili:loadTexture(imagePath .. "icon_tl_l.png")
	...
	this.widgetTable.right_icon_star_left = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.right_bg_table1, "right_icon_star_left"),"ImageView")
	this.widgetTable.right_icon_star_left:loadTexture(imagePath .. "icon_star.png")
	this.widgetTable.right_icon_star_right = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.right_bg_table1, "right_icon_star_right"),"ImageView")
	this.widgetTable.right_icon_star_right:loadTexture(imagePath .. "icon_star.png")
	this.widgetTable.right_top_btn1 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.right_bg_table1, "right_top_btn1"),"Button")
	...
	this.widgetTable.right_top_btn2 = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.right_bg_table1, "right_top_btn2"),"Button")
	...
	--right_top_bg Children
	this.widgetTable.Image_right_icon = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.right_top_bg, "Image_right_icon"),"ImageView")
	this.widgetTable.Image_right_icon:loadTexture(imagePath .. "icon_xd.png")
	...
	this.widgetTable.right_btn_zuan2:loadTexture(imagePath .. "dia.png")
	...
	this.widgetTable.right_icon_star_left = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.right_bg_table2, "right_icon_star_left"),"ImageView")
	this.widgetTable.right_icon_star_left:loadTexture(imagePath .. "icon_star.png")
	this.widgetTable.right_icon_star_right = tolua.cast(UIHelper:seekWidgetByName(this.widgetTable.right_bg_table2, "right_icon_star_right"),"ImageView")
	this.widgetTable.right_icon_star_right:loadTexture(imagePath .. "icon_star.png")
...
--领取回调
function this.lotteryCallback(amsRsp, eggFlag)
...
function this.updateWithShowData(showdata)
	...
	--设置右侧获奖展示
	local scrollIndex = 1
	local scrollLength = #this.dataTable.showData.ams_resp.scroll_rewards
	this.scrolltTimer = this:setInterval(1000,
                    function()
                        scrollIndex = scrollIndex > scrollLength and scrollIndex - scrollLength or scrollIndex
                        this.widgetTable.right_scroll_text1:setText(tostring(this.dataTable.showData.ams_resp.scroll_rewards[ scrollIndex ]))
                        --Log.d("xiangxiang index1: " .. scrollIndex)

                        scrollIndex = scrollIndex + 1
                        scrollIndex = scrollIndex > scrollLength and scrollIndex - scrollLength or scrollIndex
                        this.widgetTable.right_scroll_text2:setText(tostring(this.dataTable.showData.ams_resp.scroll_rewards[scrollIndex]))
                        --Log.d("xiangxiang index2: " .. scrollIndex)

                        scrollIndex = scrollIndex + 1
                        scrollIndex = scrollIndex > scrollLength and scrollIndex - scrollLength or scrollIndex
                        this.widgetTable.right_scroll_text3:setText(tostring(this.dataTable.showData.ams_resp.scroll_rewards[scrollIndex]))
                        --Log.d("xiangxiang index3: " .. scrollIndex)
                        --Log.d("xiangxiang length: " .. scrollLength)
                    end
    )
	...
	if this.dataTable.currentRewards and this.widgetTable.packetChildTable then
		for i=1,10 do
			...
			if isOpen == 0 then
				...
				this.widgetTable.packetChildTable[i]["packet_gift1"]:loadTexture(lotteryImgPath .. img_name)
...
function this.setMidTwoBtnAndText(changeBtnEnable,changeBtnText,openBtnEnable,openBtnText)
	...
	if changeBtnEnable then
		this.widgetTable.change_pool_btn:loadTextures(imagePath .. "btn_hjc.png", imagePath .. "btn_hjc.png", "")
		this.widgetTable.change_pool_btn:setTouchEnabled(true)
		-- this.widgetTable.change_pool_pic:loadTexture(imagePath .. "txt_normal1.png")
		this.widgetTable.normal_text1:setColor(ccc3(253,150,12))
		...
		this.widgetTable.normal_text1:setColor(ccc3(255,255,254))
		this.widgetTable.normal_text1:setText(changeBtnText)
	end
	if openBtnEnable then
		this.widgetTable.open_packet_btn:loadTextures(imagePath .. "btn_cjz.png", imagePath .. "btn_cjz.png", "")
		this.widgetTable.open_packet_btn:setTouchEnabled(true)
		-- this.widgetTable.open_packet_pic:loadTexture(imagePath .. "txt_normal2.png")
		this.widgetTable.normal_text2:setColor(ccc3(253,150,12))
		this.widgetTable.normal_text2:setText(openBtnText)
	else
		this.widgetTable.open_packet_btn:loadTextures(imagePath .. "btn_cjz_hui.png", "", "")
		...
		this.widgetTable.normal_text2:setColor(ccc3(255,255,254))
		this.widgetTable.normal_text2:setText(openBtnText)
	end
end
...
function this.setRedPoint(redPointCount)
	...
	if btn1TypeNum == 1 then
		...
		this.widgetTable.receive_bar1:loadTexture(imagePath .. "icon_tl_l_hui.png")
	...
	elseif btn2TypeNum == 2 then
		...
		this.widgetTable.receive_bar2:loadTexture(imagePath .. "icon_hld_light.png")
		this.widgetTable.receive_bar_text2:setColor(ccc3(255,255,255))
...
function this.close()
	Log.i("HLDDZNewLotteryPanel0419 close")
	if this.mainLayer then
