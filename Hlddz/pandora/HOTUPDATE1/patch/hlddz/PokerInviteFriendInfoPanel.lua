PokerInviteFriendInfoPanel = {}
local this = PokerInviteFriendInfoPanel
PObject.extend(this)
...
function this.initLayer()
	Log.i("PokerInviteFriendInfoPanel initLayer")
	...
	if not this.widgetTable.mainWidget then
		Log.e("PokerInviteFriendInfoPanel Read WidgetFromJsonFile Fail")
		return
	end
	...
	this.widgetTable.Image_content:loadTexture(imagePath .. "content_2.png")
...
function this.removeLayer()
	Log.i("PokerInviteFriendInfoPanel removeLayer")
	this.widgetTable = {}
	this.mainLayer = nil
end

function this.show()
	Log.i("PokerInviteFriendInfoPanel show")
	this.initLayer()
	if this.mainLayer then
...
function this.close()
	Log.i("PokerInviteFriendInfoPanel close")
	if this.mainLayer then
