----------------------------------------------------------------------------
--  FILE:  PokerNewLotteryTipsPanel.lua
--  DESCRIPTION:  挖宝提示
--
--  AUTHOR:	  v_rhfeng
--  COMPANY:  Tencent
--  CREATED:  2019年01月10日
-------------------------------------------------------------------------------
PokerNewLotteryTipsPanel = {}
local this = PokerNewLotteryTipsPanel
...
function PokerNewLotteryTipsPanel.initPanel()
	...
	if aWidget == nil then
		Log.i("PokerNewLotteryTipsPanel.initPanel:打开规则面板失败，请检查资源")
		return
	end
...
function PokerNewLotteryTipsPanel.show(msg, callback, ...)
	Log.i("PokerNewLotteryTipsPanel.show")
...
function PokerNewLotteryTipsPanel.showTip(msg, callback, ...)
	Log.i("PokerNewLotteryTipsPanel.show")
	this.panel = this.initPanel()
	if this.panel then
		isShowing = true
...
function PokerNewLotteryTipsPanel.close()
	if this.panel then
		popLayer(this.panel)
	end
...
function PokerNewLotteryTipsPanel.removeLayer()
	Log.i("PokerNewLotteryTipsPanel removeLayer")
